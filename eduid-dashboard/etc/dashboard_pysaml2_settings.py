...
BASE_URL = 'http://dashboard.eduid.local.emergya.info:8080/'
...
SAML_CONFIG = {
            ...
            'idp': {
                ...
                'http://idp.eduid.local.emergya.info:8080/idp.xml': {
                    'single_sign_on_service': {
                        saml2.BINDING_HTTP_REDIRECT: 'http://idp.eduid.local.emergya.info:8080/sso/redirect',
                    },
                    'single_logout_service': {
                        saml2.BINDING_HTTP_REDIRECT: 'http://idp.eduid.local.emergya.info:8080/slo/redirect',
                    },
                },
            },
        },
    ...
    # certificate
    'key_file': '/opt/eduid/eduid-dashboard/etc/dashboard-public-snakeoil.key',  # private part
    'cert_file': '/opt/eduid/eduid-dashboard/etc/dashboard-public-snakeoil.pem',  # public part
