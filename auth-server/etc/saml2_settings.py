...
BASE_URL = 'https://api.eduid.docker/auth/saml2/sp'
...
SAML_CONFIG = {
    ...
    # certificate
    'key_file': '/opt/sunet/auth-server/etc/saml.key',  # private part
    'cert_file': '/opt/sunet/auth-server/etc/saml.pem',  # public part
